...
import { PlaceOrderAction } from '../action/place-order-action';

const UnverifiedItemList = ({ infos }: any) => {
      ...
      <div className="border border-gray-300 bg-white rounded-md overflow-hidden">
        ...
        <div className="">
          ...
          <ItemInfoRow
            ...
            value={infos?.deliveryPrice ? "DZD " + infos?.deliveryPrice  : ""}
          />
 
          
        </div>
        <div className="px-6 pt-2 pb-6">
          <PlaceOrderAction infos={infos}>
          اطلب الآن 👇
          </PlaceOrderAction>
        </div>
      </div>
